...
public class ProductQuantityTest2 extends DriverFactory {
    @Test(priority = 1)
    @Description("KH-T41 Product quantity input with below the upper limit numerical data")
    public void fillProductQuantityWithBelowTheUpperLimitData () throws InterruptedException {
        //Loading home page
        ...
        product3Page.fillInTheQuantityInputField("99");
        ...
        Assert.assertEquals(cartPage.getPriceAmount(), "Részösszeg 444.510 Ft");
    }
}
