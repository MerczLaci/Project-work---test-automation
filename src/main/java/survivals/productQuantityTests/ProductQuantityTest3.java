...
public class ProductQuantityTest3 extends DriverFactory {
    @Test(priority = 1)
    @Description("KH-T42 Product quantity input with upper limit numerical data")
    public void fillProductQuantityWithUpperLimitData() throws InterruptedException {
        //Loading home page
        ...
        product3Page.fillInTheQuantityInputField("100");
        ...
        Assert.assertEquals(cartPage.getPriceAmount(), "Részösszeg 449.000 Ft");
    }
}
