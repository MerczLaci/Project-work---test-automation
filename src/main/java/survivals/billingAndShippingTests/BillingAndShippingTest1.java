...
public class BillingAndShippingTest1 extends DriverFactory {
    @Test(priority = 1)
    @Description("KH-T28 Fill mandatory and optional fields of billing data then we choose another delivery address and fill mandatory and optional fields")
    public void fillBillingDataMandatoryAndOptionalFieldsAndAnotherDeliveryAddressMandatoryAndOptionalFields() throws InterruptedException {
        //Loading home page
